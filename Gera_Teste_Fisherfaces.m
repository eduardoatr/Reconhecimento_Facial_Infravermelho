%% ===================================================================================================================
%% Teste do Fisherfaces para um conjunto de imagens
%% ===================================================================================================================
...
for distancia=1:7
    ...
    for k=1:+2:5
        ...
        % Calucla para nr de Fisherfaces de 20 em 20
        for t=10:+10:50

            % Mensagem indicando o número de Fisherfaces
            fprintf(1,'\n>>> Número de Fisherfaces: %d <<<',t);

            % Executa o fisherfaces no conjunto visível
            resV = fisherfaces(treinoV,classesV,t);

            % Executa o fisherfaces no conjunto infravermelho
            resL = fisherfaces(treinoL,classesL,t);
            ...
            for i=1:nrImagens
                ...
                recV = fisherfacesRec(resV, imgTesteV, distancia, k, false);

                % Faz o reconhecimento da imagem infravermelha
                recL = fisherfacesRec(resL, imgTesteL, distancia, k, false);
...
% Salva resultados
save('./Resultados/Resultado_Fisherfaces_Twon_x_Dark.mat','resultadosFinais');
...
% Salva resultados
save('./Resultados/Resultado_Fisherfaces_Twon_x_Off.mat','resultadosFinais');
...
% Salva resultados
save('./Resultados/Resultado_Fisherfaces_Twon_x_Ron.mat','resultadosFinais');
...
% Salva resultados
save('./Resultados/Resultado_Fisherfaces_Twon_x_Lon.mat','resultadosFinais');
...
% Salva resultados
save('./Resultados/Resultado_Fisherfaces_Twon_x_Exp.mat','resultadosFinais');
